    ...
    return (
      <Comp
        className={cn(
          ...
          variant === 'primary' &&
            'hover:border-secondary hover:bg-secondary bg-primary text-white disabled:bg-gray-400 disabled:hover:border-gray-400 disabled:hover:bg-gray-400  disabled:hover:text-black-400',
          variant === 'secondary' &&
            'hover:border-secondary hover:bg-secondary hover:text-secondary bg-transparent text-primary hover:bg-opacity-10 disabled:text-gray-400 disabled:hover:border-gray-400 disabled:hover:bg-transparent disabled:hover:text-black-400',
          variant === 'subtle' &&
